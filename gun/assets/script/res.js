...
cc.Class({
    ...
    onLoad: function()
    {
        ...
        this.playersconfig = [
            {speed:1,coin:1,fire:0,aimLen:1.0,aimSpeed:1.0},
            {speed:1.5,coin:1,fire:0,aimLen:1.0,aimSpeed:1.0},
            {speed:1,coin:1.2,fire:0,aimLen:1.0,aimSpeed:1.0},
            {speed:1,coin:1.1,fire:0,aimLen:1.0,aimSpeed:1.0},
            {speed:1,coin:1,fire:0,aimLen:1.2,aimSpeed:1.0},
            {speed:1,coin:1,fire:1,aimLen:1.0,aimSpeed:1.0},
            {speed:1,coin:1,fire:0,aimLen:1.1,aimSpeed:1.0},
            {speed:1,coin:1,fire:0,aimLen:1.0,aimSpeed:1.1},
            {speed:1,coin:1,fire:0,aimLen:1.0,aimSpeed:1.2},
            ...
            {speed:1,coin:1.1,fire:0,aimLen:1.0,aimSpeed:1.1},
            {speed:1,coin:1,fire:0,aimLen:1.15,aimSpeed:1.1},
            {speed:1,coin:1,fire:1,aimLen:1.15,aimSpeed:1.0},
            {speed:1,coin:1.2,fire:1,aimLen:1.0,aimSpeed:1.0},
            {speed:1,coin:1,fire:1,aimLen:1.0,aimSpeed:1.2}
        ];
        ...
        this.gunsconfig = [
            {aimLen:1.5,type:1,fire:2,num:1,angle:0,y:15,speed:0,score:2,coin:1.5,name:".357麦格农"},
            {aimLen:1.2,type:1,fire:3,num:1,angle:0,y:15,speed:0,score:2,coin:1.5,name:"沙漠之鹰"},
            {aimLen:0.6,type:2,fire:1,num:3,angle:8,y:15,speed:0.08,score:1,coin:1,name:"乌兹"},
            {aimLen:0.8,type:2,fire:2,num:3,angle:6,y:15,speed:0.12,score:1,coin:1,name:"M-4"},
            {aimLen:0.8,type:2,fire:2,num:3,angle:6,y:15,speed:0.12,score:1,coin:1,name:"AK-47"},
            {aimLen:1.6,type:1,fire:3,num:1,angle:0,y:15,speed:0.2,score:2,coin:1.5,name:"侦察者"},
            {aimLen:0.5,type:3,fire:2,num:3,angle:8,y:15,speed:0.2,score:1,coin:1,name:"温切斯特1887"},
            {aimLen:0.9,type:2,fire:3,num:3,angle:7,y:15,speed:0.18,score:1,coin:1,name:"M240"},
            {aimLen:2,type:1,fire:4,num:1,angle:0,y:15,speed:0.2,score:2,coin:1.5,name:"AWP"},
            {aimLen:3.0,type:1,fire:5,num:1,angle:0,y:2,speed:0.2,score:2,coin:1.8,name:"巴雷特M82A1"},

            {aimLen:1.0,type:3,fire:2,num:4,angle:8,y:15,speed:0,score:1.2,coin:1.2,name:"超级散弹枪"},
            {aimLen:0.8,type:2,fire:2,num:4,angle:7,y:15,speed:0.06,score:1,coin:1,name:"P90"},
            {aimLen:1.2,type:3,fire:3,num:2,angle:7,y:15,speed:0,score:1.2,coin:1.2,name:"麻烦制造者"},
            {aimLen:1,type:2,fire:2,num:4,angle:7,y:15,speed:0.15,score:1,coin:1,name:"毁灭者"},
            {aimLen:0.5,type:3,fire:2,num:5,angle:15,y:15,speed:0,score:1,coin:1,name:"死神"},
            {aimLen:0.7,type:2,fire:1,num:5,angle:5,y:15,speed:0.06,score:1,coin:1,name:"幻灭"},
            {aimLen:1.2,type:1,fire:5,num:1,angle:0,y:15,speed:0,score:3,coin:2,name:"神力"},
            {aimLen:0.9,type:2,fire:3,num:3,angle:3,y:15,speed:0.08,score:1,coin:1,name:"STAG"},
            {aimLen:1.5,type:1,fire:7,num:1,angle:0,y:15,speed:0,score:3,coin:2,name:"巨人"},

            {aimLen:1.2,type:2,fire:3,num:4,angle:3,y:15,speed:0.08,score:2,coin:2,name:"火星枪"}
        ];
